                        ...
                        <div class="body px-7 pt-3 pb-7 overflow-hidden w-full">
                            ...
                            <div class="row flex justify-between gap-4">
                                ...
                                <div class="form-group w-1/2">
                                    ...
                                    <input type="text" id="landLocation" wire:model="landLocation"
                                        class="border border-gray-300 p-2 outline-none w-full mt-2 rounded-md">
                                    @error('landLocation')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                            ...
                            <div class="row flex gap-4">
                                <div class="form-group w-1/2">
                                    ...
                                    <input type="text" id="ejari" wire:model="ejari"
                                        class="border border-gray-300 p-2 outline-none w-full mt-2 rounded-md">
                                    @error('ejari')
                                        <span class="text-danger">{{ $message }}</span>class="border border-gray-300
                                        p-2 outline-none w-full mt-2 rounded-md"
                                    @enderror
                                </div>
                                <div class="form-group w-1/2">
                                ...
                                <div class="flex flex-col mb-4">
                                    ...
                                    <div class="relative inline-flex">
                                        ...
                                        <select
                                            ...
                                            <option value="" selected class="text-grey-600">
                                                {{ __('app.Choose Apartment') }}</option>
                                            @foreach ($apartments as $apartment)
                                                <option value="{{ $apartment->id }}" class="text-grey-600">
                                                    {{ $apartment->number }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    @error('apartment_id')
